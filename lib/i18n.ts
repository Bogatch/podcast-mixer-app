...
export const translations = {
  en: {
    ...
    // Smart Tools
    'smart_cutting_title': 'Smart Cutting (AI)',
    'smart_cutting_trim_silence': 'Trim Silence',
    'smart_cutting_silence_threshold': 'Silence Threshold',
    'smart_cutting_smart_leveling': 'Smart Leveling',
    ...
    'tooltip_trim_silence': 'Automatically remove leading and trailing silence from all tracks.',
    'tooltip_silence_threshold': 'The volume level (in dB) below which audio is considered silence. Lower values are stricter.',
    'tooltip_smart_leveling': 'Automatically adjust the volume of each track to a consistent level. You can fine-tune it later with the track volume slider.',
    ...
    'help_section_smart_tools': 'Smart Tools (AI)',
    'help_detail_smart_tools_p1': 'These AI-powered tools help you automate common editing tasks to speed up your workflow.',
    'help_smart_tools_trim_silence_title': 'Trim Silence',
    'help_smart_tools_trim_silence_desc': 'Analyzes each track and automatically removes silence from the beginning and end. You can adjust the sensitivity with the "Silence Threshold" slider. The trimmed sections can be manually adjusted by dragging the handles on the waveform.',
    'help_smart_tools_smart_leveling_title': 'Smart Leveling',
    'help_smart_tools_smart_leveling_desc': 'Analyzes the loudness of each track and automatically adjusts its volume to ensure a consistent level across the entire mix. This is a great starting point, and you can still fine-tune the volume of each track individually.',
  ...
  sk: {
    ...
    // Smart Tools
    'smart_cutting_title': 'Inteligentné Strihanie (AI)',
    'smart_cutting_trim_silence': 'Strihať Ticho',
    'smart_cutting_silence_threshold': 'Prah Ticha',
    'smart_cutting_smart_leveling': 'Inteligentná Hlasitosť',
    ...
    'tooltip_trim_silence': 'Automaticky odstráni počiatočné a koncové ticho zo všetkých stôp.',
    'tooltip_silence_threshold': 'Úroveň hlasitosti (v dB), pod ktorou sa zvuk považuje za ticho. Nižšie hodnoty sú prísnejšie.',
    'tooltip_smart_leveling': 'Automaticky upraví hlasitosť každej stopy na konzistentnú úroveň. Neskôr ju môžete doladiť posuvníkom hlasitosti stopy.',
    ...
    'help_section_smart_tools': 'Inteligentné Nástroje (AI)',
    'help_detail_smart_tools_p1': 'Tieto nástroje poháňané AI vám pomôžu zautomatizovať bežné editačné úlohy a zrýchliť tak váš pracovný postup.',
    'help_smart_tools_trim_silence_title': 'Strihať Ticho',
    'help_smart_tools_trim_silence_desc': 'Analyzuje každú stopu a automaticky odstráni ticho zo začiatku a konca. Citlivosť môžete upraviť posuvníkom "Prah Ticha". Orezané časti je možné manuálne upraviť potiahnutím úchytov na zvukovej krivke.',
    'help_smart_tools_smart_leveling_title': 'Inteligentná Hlasitosť',
    'help_smart_tools_smart_leveling_desc': 'Analyzuje hlasitosť každej stopy a automaticky upraví jej hlasitosť, aby sa zabezpečila konzistentná úroveň v celom mixe. Toto je skvelý východiskový bod a stále môžete doladiť hlasitosť každej stopy individuálne.',
