...
export const HelpModal: React.FC<{ onClose: () => void }> = ({ onClose }) => {
    ...
    // FIX: The i18n `t` function does not support React elements as parameters.
    // To embed the <Key> component, we get the string with the placeholder,
    // split it, and manually insert the component.
                ...
                <AccordionItem title={t('help_section_ai_tools')}>
                    ...
                    <ul className="list-disc list-inside space-y-2 pl-2 mt-4">
                        ...
                        <li><b>{t('help_detail_ai_leveling_title')}</b> {t('help_detail_ai_leveling_p1')}</li>
                         <li><b>{t('ai_content_assistant_title')} (PRO)</b> {t('help_detail_ai_content_p1')}</li>
                    </ul>
                </AccordionItem>
